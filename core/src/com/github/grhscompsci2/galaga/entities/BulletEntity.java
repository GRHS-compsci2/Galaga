...
public class BulletEntity extends Entity {
        ...
        public void init(Engine engine, BodyFactory bodyFactory) {
                ...
                b2d.body = bodyFactory.makeBoxPolyBody(x, y + 1.5f, 1.5f, 1.5f, BodyFactory.STONE, BodyType.DynamicBody,
                                BodyFactory.CATEGORY_MISSLE, BodyFactory.MASK_MISSLE, true);
                add(b2d);

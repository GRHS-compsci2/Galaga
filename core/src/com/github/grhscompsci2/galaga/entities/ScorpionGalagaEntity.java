...
public class ScorpionGalagaEntity extends Entity {
    public void init(Engine engine, BodyFactory bodyFactory) {
        ...
        keyFrames.add(Utility.getTextureRegionAsset("scorpion1"));
        ...
        tex.region = Utility.getTextureRegionAsset("scorpion1");
        super.add(tex);
